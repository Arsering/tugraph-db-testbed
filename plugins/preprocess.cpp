...
/**
 * @brief 将 vit 当前指向的顶点的 fid 对应的property的值改为这个值 (这个值对应本图中的另外一个顶点，比如person) 对应的 vid 
 * 
 * @param txn 
 * @param vit 
 * @param fid 
...
/**
 * @brief 给 forum_hasmember_person_edges 这种edge预先计算一些统计值？？？（这算作弊嘛）
 * 
 * @param db 
 */
